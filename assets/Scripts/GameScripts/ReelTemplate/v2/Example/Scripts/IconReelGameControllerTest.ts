...
import { GameMode } from '../../../../Definition';
import { GenericUIManager } from '../../../../GenericUI/Scripts';
...
@ccclass('IconReelGameControllerTest')
export class IconReelGameControllerTest extends GameController {
    @property({ type: IconSlotMachine, visible: true })
    private _slotMachine: IconSlotMachine = null;
