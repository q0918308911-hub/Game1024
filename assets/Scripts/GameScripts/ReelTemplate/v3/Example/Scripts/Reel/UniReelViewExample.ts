...
import { UniReelExample } from './UniReelExample';
import { UniReelView } from '../../../Scripts/UniReelView';
import { SymbolNumber } from '../SymbolNumber';

const { ccclass, property } = _decorator;

@ccclass('UniReelViewExample')
export class UniReelViewExample extends UniReelView<UniReelExample> {
    @property(Node)
