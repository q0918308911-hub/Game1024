import { _decorator, CCInteger, Label, Node } from 'cc';
import { SymbolNumber } from '../SymbolNumber';
import { UniDropReelExample } from './UniDropReelExample';
import { UniDropReelView } from '../../../Scripts/DropReel/UniDropReelView';
const { ccclass, property } = _decorator;

@ccclass('DropUniReelViewExample')
export class UniDropReelViewExample extends UniDropReelView<UniDropReelExample> {
    @property(Node)
