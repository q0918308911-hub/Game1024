import { _decorator, CCFloat, Color, Component, debug, Material, Sprite, SpriteFrame, UITransform, Vec2, Vec3 } from 'cc';
const { ccclass, property } = _decorator;

@ccclass('SpriteAttiveHandler')
/**
 *  刷光效果Component，用來控制刷光的Sprite
*/
export class SpriteAttiveHandler extends Component {
     ...
     */
    private spriteUITrans: UITransform = null;
    /**
     * 目標Sprite的UITransform size
     */
    private spriteUITransSize: Vec2 = null;
