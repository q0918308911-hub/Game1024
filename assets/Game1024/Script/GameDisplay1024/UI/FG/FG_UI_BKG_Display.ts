...
@ccclass('FG_UI_BKG_Display')
export class FG_UI_BKG_Display extends ContainerWholeBehavior {
   
    @property({ type: SpineController, visible: true,displayName:'Spine Controller' ,tooltip: 'FG_UI_BKG_Display' })
    ...
    protected onLoad(): void {
        ...
        //--也可以這樣用..
        //this._bg_SpineController.node.on(ANI_SYS_EVENTS.CTRL_LOADED, this.onSpineCtrlLoaded);
    }
    ...
    protected doDefaultResizeProcess(value: Orientation): void {
        ...
        if(this._bg_SpineController){
            ...
            this._bg_SpineController.playAni({ aniState: SLOT_FRAME_NG_ANI_STATE.FG_BG_UI });
        }
    }
